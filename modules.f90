    ...
    if (Win%fromFile) then
    
       
       count_obs_window_z = spline_val(z, Win%zvals, Win%pvals, Win%p2, Win%Nz)


       winamp = count_obs_window_z


       if (z<Win%minz .or. z>Win%maxz) then
       ...
       !if (z>1.6) then
       !   if (count_obs_window_z>0.2) then
       !      print *,z
       !   end if
       !   count_obs_window_z = 0. 
       !end if
